            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('user-update') }}" aria-label="Configuración de mi Cuenta">
                        ...
                        <!-- SUBIR UNA IMAGEN PARA EL AVATAR DEL USUARIO -->
                        <div class="form-group row">
                            <label for="image_path" class="col-md-4 col-form-label text-md-right">{{ __('Preview de Avatar') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <label for="image_path" class="col-md-4 col-form-label text-md-right">{{ __('Imagen de Avatar') }}</label>
